...
<head>
    ...
    <title>Contact Us - Get Every Thing</title>
        ...
        <nav class="teal" role="navigation">
            ...
            <div class="nav-wrapper nav-content">
                ...
                <ul id="dropdown3" class="dropdown-content">
                    ...
                    <li><a href="http://get-everything.great-site.net/Share-On-Gmail" rel="nofollow" target="_blank"><i style="margin-left:-5px;color:#c12127;" class="fa fa-google fa-sm"><span style="margin-right:5px;"></span><strong style="font-weight:900;font-size:10px;">Gmail</strong></i></a></li>

                    <li class="divider"></li>

                    <li><a href="http://get-everything.great-site.net/Share-On-Facebook" rel="nofollow" target="_blank"><i style="margin-left:-5px;color:#3b5999;" class="fa fa-facebook-square fa-sm"><span style="margin-right:5px;"></span><strong style="font-weight:900;font-size:10px;">Facebook</strong></i></a></li>

                    <li class="divider"></li>

                    <li><a href="http://get-everything.great-site.net/Share-On-WhatsApp" rel="nofollow" target="_blank"><i style="margin-left:-5px;color:#47fa47;" class="fa fa-whatsapp fa-sm"><span style="margin-right:5px;"></span><strong style="font-weight:900;font-size:10px;">WhatsApp</strong></i></a></li>

                    <li class="divider"></li>

                    <li><a href="http://get-everything.great-site.net/Share-On-Twitter" rel="nofollow" target="_blank"><i style="margin-left:-5px;color:#55acee;" class="fa fa-twitter-square fa-sm"><span style="margin-right:5px;"></span><strong style="font-weight:900;font-size:10px;">Twitter</strong></i></a></li>

                    <li class="divider"></li>

                    <li><a href="http://get-everything.great-site.net/Share-On-Instagram" rel="nofollow" target="_blank"><i style="margin-left:-5px;color:#8a3ab9;" class="fa fa-instagram fa-sm"><span style="margin-right:5px;"></span><strong style="font-weight:900;font-size:10px;">Instagram</strong></i></a></li>
                ...
                <div class="row z-depth-1 hoverable">
                    ...
                    <div class="col s12">
                        ...
                        <div class="container ContactForm">
                            ...
                            <form id="form" action="http://get-everything.great-site.net/geteverything/contact_page" method="POST">
