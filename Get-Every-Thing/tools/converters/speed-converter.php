...
<head>
  ...
  <title>Speed Converter - Get Every Thing</title>
...
<body>
  ...
  <div class="left-align privacypolicy ContactForm">
    ...
    <h4 class="center"><u>Speed Converter</u></h4>
    ...
    <div class="container row z-depth-1" style="padding:20px;">
      ...
      <div class="col l6 s12" style="padding:20px;">
        ...
        <div class="input-field">
          ...
          <select id="unit" class="btn green" onchange="convertData()">
            ...
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;" selected="selected">Mile/hour (mph)</option>
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Kilometer/hour​ (kmh)</option>
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Foot/second (fts)</option>
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Meter/second (ms)</option>
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Knot‌ (knot)</option>
        ...
        <p>
          ...
          This speed converter can convert between different speed units,

          you just need to enter a original value and select the original unit in combobox,

          converter will quickly calculate all the values of other speed units.
        ...
        <ul>
          ...
          <li>Select an original Speed unit, such as Mile/hour, Kilometer/hour​, Foot/second or other.</li>
        ...
        <ul>
          ...
          <li>Speed of an object is often referred to as the time rate at which an object is moving along a path</li>
          <li>Velocity is the rate and direction of an object's movement.</li>
          <li id="scroll_result">Speed is a scalar value, while velocity is a vector.</li>
      ...
      <div class="col l3 s12" style="padding:20px;">
        ...
        <div id="item-1">Mile/hour (mph)</div>

        <input type="text" id="output-1" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 mph" readonly="readonly" />

        <div id="item-2">Kilometer/hour​ (kmh)</div>

        <input type="text" id="output-2" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 sq. kmh" readonly="readonly" />

        <div id="item-3">Foot/second (fts)</div>

        <input type="text" id="output-3" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 fts" readonly="readonly" />

        <div id="item-4">Meter/second (ms)</div>

        <input type="text" id="output-4" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 ms" readonly="readonly" />

        <div id="item-5">Knot‌ (knot)</div>

        <input type="text" id="output-5" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 knot" readonly="readonly" />
