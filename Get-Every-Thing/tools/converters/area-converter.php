...
<head>
  ...
  <title>Area Converter - Get Every Thing</title>
...
<body>
  ...
  <div class="left-align privacypolicy ContactForm">
    ...
    <h4 class="center"><u>Area Converter</u></h4>
    ...
    <div class="container row z-depth-1" style="padding:20px;">
      ...
      <div class="col l6 s12" style="padding:20px;">
        ...
        <div class="input-field">
          ...
          <input type="text" id="input" name="input" value="" required style="color:teal;font-weight:bold;" class="validate input-text" autocomplete="off" maxlength="12" pattern="^[\-\+]?(([1-9](\d*|\d{0,2}(,\d{3})*))|0)(\.\d{1,2})?$" />

          <br /><br />

          <select id="unit" class="btn green" onchange="convertData()">

            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Square Meter​ (sq .m)</option>
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;" selected="selected">Square Kilometer (sq .km)</option>
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Square Mile (sq .mile)</option>
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Square Yard​ (sq .yd)</option>
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Square Foot​ (sq .ft)</option>
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Square Inch‌ (sq .in)</option>
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Acre (ac)</option>
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Centiare (ca)</option>
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Decare (daa)</option>
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Are (are)</option>
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Hectare (ha)</option>
        ...
        <p>
          ...
          This area converter can convert between different area units,

          you just need to enter a original value and select the original unit in combobox,

          converter will quickly calculate all the values of other area units.
        ...
        <ul>
          ...
          <li>Select an original Area unit, such as Square Meter​, Square Kilometer, Square Mile or other.</li>
        ...
        <ul>
          ...
          <li>Area of an object is often referred to as the amount of space within the perimeter of a 2D shape.</li>
          <li>Area measures the space inside a shape.</li>
          <li id="scroll_result"> The area of a figure is the number of unit squares that cover the surface of a closed figure.</li>
      ...
      <div class="col l3 s12" style="padding:20px;">
        ...
        <div id="item-1">Square Meter (sq. m)</div>

        <input type="text" id="output-1" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 sq. m" readonly="readonly" />

        <div id="item-2">Square Kilometer (sq. km)</div>

        <input type="text" id="output-2" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 sq. km" readonly="readonly" />

        <div id="item-3">Square Mile (sq. mile)</div>

        <input type="text" id="output-3" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 sq. mile" readonly="readonly" />

        <div id="item-4">Square Yard (sq. yd)</div>

        <input type="text" id="output-4" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 sq. yd" readonly="readonly" />

        <div id="item-5">Square Foot (sq. ft)</div>

        <input type="text" id="output-5" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 ft" readonly="readonly" />

        <div id="item-6">Square Inch‌ (sq. in)</div>

        <input type="text" id="output-6" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 sq. in" readonly="readonly" />

        <div id="item-7">Acre (ac)</div>

        <input type="text" id="output-7" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 ac" readonly="readonly" />

        <div id="item-8">Centiare (ca)</div>

        <input type="text" id="output-8" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 ca" readonly="readonly" />

        <div id="item-9">Decare (daa)</div>

        <input type="text" id="output-9" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 daa" readonly="readonly" />

        <div id="item-10">Are (are)</div>

        <input type="text" id="output-10" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 are" readonly="readonly" />

        <div id="item-11">Hectare (ha)</div>

        <input type="text" id="output-11" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 ha" readonly="readonly" />

      </div>

      <form>

        <input type="hidden" id="factors" value="1000000,1,0.38610216,196000,10764000,1550000000,247.105381,1000000,10000000,100000000,100" />
