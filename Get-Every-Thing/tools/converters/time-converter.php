...
<head>
  ...
  <title>Time Converter - Get Every Thing</title>
  ...
  <meta name="description" content="Convert between various weight units, such as Microgram, Milligram, Kilogram, Pound, Ounce, Gram and more." />
...
<body>
  ...
  <div class="left-align privacypolicy ContactForm">
    ...
    <h4 class="center"><u>Time Converter</u></h4>
    ...
    <div class="container row z-depth-1" style="padding:20px;">
      ...
      <div class="col l6 s12" style="padding:20px;">
        ...
        <div class="input-field">
          ...
          <select id="unit" class="btn green" onchange="convertData()">
            ...
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Millisecond</option>

            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Second​</option>

            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Minute</option>

            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;" selected="selected">Hour</option>

            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Day</option>

            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Week​</option>

            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Month​</option>

            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Year</option>
        ...
        <p>
          ...
          This time converter can convert between different time units,
          ...
          converter will quickly calculate all the values of other time units.
        ...
        <ul>
          ...
          <li>Select an original Time unit, such as Millisecond, Second​, Minute or other.</li>
        ...
        <ul>
          ...
          <li>Time is often referred to as the indefinite continued progress of existence and events in the past, present, and future regarded as a whole.</li>

          <li>It define as the duration in which all things happen, or a precise instant that something happens.</li>

          <li id="scroll_result">The concept of time is self-evident.</li>
      ...
      <div class="col l3 s12" style="padding:20px;">
        ...
        <div id="item-1">Millisecond (ms)</div>



        <input type="text" id="output-1" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 ms" readonly="readonly" />



        <div id="item-2">Second (s)</div>



        <input type="text" id="output-2" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 s" readonly="readonly" />



        <div id="item-3">Minute (min)</div>



        <input type="text" id="output-3" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 min" readonly="readonly" />



        <div id="item-4">Hour (h)</div>



        <input type="text" id="output-4" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 h" readonly="readonly" />



        <div id="item-5">Day (day)</div>



        <input type="text" id="output-5" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 day" readonly="readonly" />



        <div id="item-6">Week​ (week)</div>



        <input type="text" id="output-6" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 week" readonly="readonly" />



        <div id="item-7">Month​ (month)</div>



        <input type="text" id="output-7" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 month​" readonly="readonly" />



        <div id="item-8">Year (year)</div>



        <input type="text" id="output-8" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 year" readonly="readonly" />
      ...
      <form>
        ...
        <input type="hidden" id="factors" value="3600000,3600,60,1,0.04166667,0.00595238,0.00136893,0.00011408" />
