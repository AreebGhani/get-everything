...
<head>
  ...
  <title>Temperature Converter - Get Every Thing</title>
...
<body>
  ...
  <div class="left-align privacypolicy ContactForm">
    ...
    <h4 class="center"><u>Temperature Converter</u></h4>
    ...
    <div class="container row z-depth-1" style="padding:20px;">
      ...
      <div class="col l6 s12" style="padding:20px;">
        ...
        <div class="input-field">
          ...
          <select id="unit" class="btn green" onchange="convertCustom()">

            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;" selected="selected">Celsius (C)</option>
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Fahrenheit (F)</option>
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Kelvin (K)</option>
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Rankine (Ra)</option>
          ...
          <a href="#result" class="smooth-scroll">
            <input type="button" id="convert-button" class="btn blue" value="Convert" onclick="convertCustom()" />
          </a>
        ...
        <p>
          ...
          This temperature converter can convert between different temperature units,

          you just need to enter a original value and select the original unit in combobox,

          converter will quickly calculate all the values of other temperature units.
        ...
        <ul>
          ...
          <li>Select an original Temperature unit, such as Celsius, Fahrenheit, Kelvin or other.</li>
        ...
        <ul>
          ...
          <li>Temperature of an object is often referred to as the degree or intensity of heat present in a substance or object, especially as expressed according to a comparative scale and shown by a thermometer or perceived by touch.</li>
          <li>It measures the degree of internal heat of a person's body.</li>
          <li id="scroll_result">It is a measure of the average kinetic energy of the particles in an object.</li>
      ...
      <div class="col l3 s12" style="padding:20px;">
        ...
        <div id="item-1">Celsius (C)</div>

        <input type="text" id="output-1" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 C" readonly="readonly" />

        <div id="item-2">Fahrenheit (F)</div>

        <input type="text" id="output-2" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 F" readonly="readonly" />

        <div id="item-3">Kelvin (K)</div>

        <input type="text" id="output-3" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 K" readonly="readonly" />

        <div id="item-4">Rankine (Ra)</div>

        <input type="text" id="output-4" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 Ra" readonly="readonly" />

      </div>

      <form>

        <input type="hidden" id="factors" value="1,2,3,4" />
  ...
  <script>
    function convertCustom() {
      ...
      if (isNaN(v)) return;
      var fs = new Array();
      var e = document.getElementById('factors');
      if (e) {
        fs = e.value.split(',')
      }
      var f = getFactor(fs);
      if (isNaN(f)) return;
      var o1 = document.getElementById('output-1');
      if (!o1) return;
      var o2 = document.getElementById('output-2');
      if (!o2) return;
      var o3 = document.getElementById('output-3');
      if (!o3) return;
      var o4 = document.getElementById('output-4');
      if (!o4) return;
      if (f == 1) {
        o1.value = v;
        o2.value = formatFloat((v * (9 / 5) + 32), 6, 4);
        o3.value = formatFloat((v + 273.15), 6, 4);
        o4.value = formatFloat(((v + 273.15) * (9 / 5)), 6, 4);
      };
      if (f == 2) {
        o1.value = formatFloat(((v - 32) * (5 / 9)), 6, 4);
        o2.value = v;
        o3.value = formatFloat(((v + 459.67) * (5 / 9)), 6, 4);
        o4.value = formatFloat((v + 459.67), 6, 4);
      };
      if (f == 3) {
        o1.value = formatFloat((v - 273.15), 6, 4);
        o2.value = formatFloat((v * (9 / 5) - 459.67), 6, 4);
        o3.value = v;
        o4.value = formatFloat((v * (9 / 5)), 6, 4);
      };
      if (f == 4) {
        o1.value = formatFloat((v - 491.67) * (5 / 9), 6, 4);
        o2.value = formatFloat((v - 459.67), 6, 4);
        o3.value = formatFloat((v * (5 / 9)), 6, 4);
        o4.value = v;
      };
    }
  </script>
