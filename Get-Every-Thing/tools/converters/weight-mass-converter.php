...
<head>
  ...
  <title>Weight / Mass Converter - Get Every Thing</title>
...
<body>
  ...
  <div class="left-align privacypolicy ContactForm">
    ...
    <h4 class="center"><u>Weight / Mass Converter</u></h4>
    ...
    <div class="container row z-depth-1" style="padding:20px;">
      ...
      <div class="col l6 s12" style="padding:20px;">
        ...
        <div class="input-field">
          ...
          <select id="unit" class="btn green" onchange="convertData()">
            ...
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Microgram (ug)</option>
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Milligram (mg)</option>
            <option selected="selected" class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Kilogram (kg)</option>
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Pound (lb)</option>
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Gram (g)</option>
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Ounce (oz)</option>
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Carat (ct)</option>
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Metric Ton (t)</option>
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Short Ton (ton)</option>
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Long Ton (lt)</option>
            <option class="grey lighten-2 teal-text" style="text-transform:capitalize;font-size:small;font-weight:900;">Stone (st)</option>
        ...
        <p>
          ...
          This weight converter can convert between different weight units,

          you just need to enter a original value and select the original unit in combobox,

          will quickly calculate all the values of other weight units.
        ...
        <ul>
          ...
          <li>Select an original Weight unit, such as Microgram, Milligram, Kilogram or other.</li>
        ...
        <ul>
          ...
          <li>Mass of an object is often referred to as its weight though two units are not the same.</li>
          <li>Weight is a force and a measure of how strongly gravity.</li>
          <li id="scroll_result">Mass is a numerical description of how much matter something contains.</li>
      ...
      <div class="col l3 s12" style="padding:20px;">
        ...
        <div id="item-1">Microgram (ug)</div>

        <input type="text" id="output-1" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 ug" readonly="readonly" />

        <div id="item-2">Milligram (mg)</div>

        <input type="text" id="output-2" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 mg" readonly="readonly" />

        <div id="item-3">Kilogram (kg)</div>

        <input type="text" id="output-3" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 kg" readonly="readonly" />

        <div id="item-4">Pound (lb)</div>

        <input type="text" id="output-4" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 lb" readonly="readonly" />

        <div id="item-5">Gram (g)</div>

        <input type="text" id="output-5" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 g" readonly="readonly" />

        <div id="item-6">Ounce (oz)</div>

        <input type="text" id="output-6" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 oz" readonly="readonly" />

        <div id="item-7">Carat (ct)</div>

        <input type="text" id="output-7" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 ct" readonly="readonly" />

        <div id="item-8">Metric Ton (t)</div>

        <input type="text" id="output-8" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 t" readonly="readonly" />

        <div id="item-9">Short Ton (ton)</div>

        <input type="text" id="output-9" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 ton" readonly="readonly" />

        <div id="item-10">Long Ton (lt)</div>

        <input type="text" id="output-10" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 lt" readonly="readonly" />

        <div id="item-11">Stone (st)</div>

        <input type="text" id="output-11" style="color:teal;font-weight:bold;" class="input-text" placeholder="0.00 st" readonly="readonly" />

      </div>

      <form>

        <input type="hidden" id="factors" value="1000000000,1000000,1,2.20462262,35.273962,1000,5000,0.001,0.00110231,0.00098421,0.15747304" />
